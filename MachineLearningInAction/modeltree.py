...
def linearSolve(dataSet):
    ...
    if linalg.det(xTx) == 0.0:
        raise NameError('This matrix is singular, cannot do inverse, try increasing the second value of ops1')
    ws = xTx.I*(X.T*Y)
    return ws,X,Y
...
path = '/Users/lyj/Programs/Codes&Data/MachineLearningInAction/Ch09/exp2.txt'
myDat = loadDataSet(path)
result = createTree(myDat, modelLeaf, modelErr, (1,10))
print result